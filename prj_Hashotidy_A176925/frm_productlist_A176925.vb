Public Class frm_productlist_A176925
    Private Sub frm_productlist_A176925_Load(sender As Object, e As EventArgs) Handles MyBase.Load
		refresh_grid()
	End Sub
	...
	Private Sub refresh_grid()
		...
		Dim mysql As String = "SELECT * FROM TBL_PRODUCTS_A176925"
